...
// [ed25519.PublicKey] (not a pointer), *[mldsa65.PublicKey],
// or *[ecdh.PublicKey] (for X25519).
...
// *[mldsa65.PublicKey], and *[ecdh.PublicKey].
...
var (
	...
	oidSignatureMLDSA65         = asn1.ObjectIdentifier{2, 16, 840, 1, 101, 3, 4, 3}
...
var signatureAlgorithmDetails = []struct {
	...
	{PureMLDSA65, "MLDSA65", oidSignatureMLDSA65, emptyRawValue, MLDSA65, crypto.Hash(0) /* no pre-hashing */, false},
}
...
var (
	...
	//            country(16) us(840) organization(1) gov(101) csor(3)
	//            nistAlgorithm(4) sigAlgs(3) TBD }
	oidPublicKeyMLDSA65 = asn1.ObjectIdentifier{2, 16, 840, 1, 101, 3, 4, 3}
)
...
func checkSignature(algo SignatureAlgorithm, signed, signature []byte, publicKey crypto.PublicKey, allowSHA1 bool) (err error) {
	...
	switch hashType {
	case crypto.Hash(0):
		if pubKeyAlgo != Ed25519 && pubKeyAlgo != MLDSA65 {
			return ErrUnsupportedAlgorithm
		}
	case crypto.MD5:
	...
	case ed25519.PublicKey:
		...
		return
	case *mldsa65.PublicKey:
		if pubKeyAlgo != MLDSA65 {
			return signaturePublicKeyAlgoMismatchError(pubKeyAlgo, pub)
		}
		if !mldsa65.Verify(pub, signed, []byte{}, signature) {
...
// ed25519.PublicKey and *mldsa65.PublicKey. pub must be a supported key type,
// and priv must be a crypto.Signer or crypto.MessageSigner with a supported public key.
//
...
// a *ecdsa.PublicKey or a ed25519.PublicKey or a *mldsa65.PublicKey. (A *rsa.PrivateKey,
// *ecdsa.PrivateKey or ed25519.PrivateKey or *mldsa65.PublicKey satisfies this.)
//
