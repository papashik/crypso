...
// a pointer), a *[mldsa65.PrivateKey], or an *[ecdh.PrivateKey] (for X25519). 
...
func ParsePKCS8PrivateKey(der []byte) (key any, err error) {
	...
	case privKey.Algo.Algorithm.Equal(oidPublicKeyMLDSA65):
		...
		err := key.UnmarshalBinary(privKey.PrivateKey)
		return &key, err
...
// *[ecdsa.PrivateKey], [ed25519.PrivateKey] (not a pointer), *[mldsa65.PrivateKey] and *[ecdh.PrivateKey].
